    ...
    <#elseif section = "form">
        ...
        <div id="kc-form">
            <div id="kc-form-wrapper">
                <form id="kc-create-organization-form" class="${properties.kcFormClass!}" action="${url.loginAction}"
                      method="post">
                    <div class="${properties.kcFormGroupClass!}">
                        ...
                        <#if messagesPerField.existsError('orgName')>
                            <span id="input-error-orgName" class="${properties.kcInputErrorMessageClass!}"
                                  aria-live="polite">
                    ...
                    <#list attributes?keys as attributeName>
                        <div class="${properties.kcFormGroupClass!}">
                            ...
                            <#if messagesPerField.existsError("orgAttr_${attributeName}")>
                                <span id="input-error-orgAttr_${attributeName}"
                    ...
                    <#if !isDomainGenerationEnabled>
                        <div class="${properties.kcFormGroupClass!}">
                            ...
                            <#if messagesPerField.existsError('orgDomain')>
                                <span id="input-error-orgDomain" class="${properties.kcInputErrorMessageClass!}"
                                      aria-live="polite">
